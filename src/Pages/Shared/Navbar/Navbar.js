...
const Navbar = () => {
    ...
    return (
        <div className='bg-neutral'>
            <div className='text-center'><Link to={'/'} className="btn btn-ghost normal-case text-xl lg:hidden text-white">
                <img className='h-8 mr-2' src="learning-endless.png" alt="" />Learning Endless</Link></div>
            <div className="navbar bg-neutral px-8 text-white shadow-2xl">
                <div className="navbar-start">
                    ...
                    <Link to={'/'} className="btn btn-ghost normal-case text-xl hidden lg:flex ">
                        <img className='h-8 mr-2' src="learning-endless.png" alt="" />Learning Endless</Link>
                </div>
